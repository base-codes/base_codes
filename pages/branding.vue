  ...
  <div class="page-content">
      ...
      <div class="column is-12">
        ...
        <div class="columns">
          <div class="column is-two-thirds flex">
            ...
            <div class="column el">
              <h2>Айдентика</h2>
              <p>Разработка и формирование платформы бренда, тональности и стиля общения с ЦА, миссия и ключевая метафора бренда, позиционирование бренда</p>
            </div>
            <!-- <p>
    ...
    <section class="about-us">
      <div class="columns">
        ...
        <div class="jak_pracujeme">
          <div class="column">
            <p>Beyond can help you throughout your digital journey. We partner with marketing, product and board level leaders to help you understand your customers better - and then build the right products and experiences to serve them. We work with you to define your product vision, design a strategy and improve your business outcomes.</p>
            <div class="content">
              <h2>Нематериальные образы</h2>
              <p>
                Бренд как пропуск в особый мир, присутствие в котором иногда важнее самого процесса потребления.<br>
                Мы создаём ассоциации, возникающие в сознании потребителя, ожидания. Мы создаём ассоциации, возникающие в сознании потребителя, ожидания.
              </p>
            </div>
            <div class="content">
